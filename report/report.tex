...
\usepackage{xeCJK}
\usepackage[protrusion=true]{microtype}  % 收掉零星 overfull(字符突出)
\geometry{margin=2.4cm}
\setlength{\emergencystretch}{3em}        % 末路伸缩,消除参考文献等零星 overfull
...
\begin{itemize}
  \item \textbf{50 anomaly long--short portfolios} (main dataset,
  \texttt{managed\_\allowbreak portfolios\_\allowbreak anom\_\allowbreak d\_50.csv}):
...
\subsection{R1 --- FF25 preliminary analysis (a negative control)}\label{sec:r1}
...
\begin{tabular}{>{\raggedright\arraybackslash}p{3.7cm} >{\raggedright\arraybackslash}p{3.5cm} p{7.0cm}}
\toprule
